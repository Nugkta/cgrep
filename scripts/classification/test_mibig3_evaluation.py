...
# -*- coding: utf-8 -*-
"""
Test Script for MIBiG 3.0 Stratified Evaluation Pipeline
========================================================
...
def create_test_data(n_samples=50, seq_len_range=(5, 20), emb_dim=256):
    """Create synthetic test data that mimics the real MIBiG 3.0 structure."""
...
def test_output_generation():
    ...
    try:
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            from scripts.classification.mibig3_stratified_evaluation import create_comparison_table
            ...
            if df_comparison is not None:
                ...
                # Check output files
                csv_file = os.path.join(temp_dir, "mibig3_comparison.csv")
...
def test_pipeline_integration():
    ...
    try:
        ...
        import scripts.classification.mibig3_stratified_evaluation as main_eval
        ...
        parser.add_argument("--outdir", default="results/test_mibig3")
...
def run_all_tests():
    ...
    print("🚀 MIBiG 3.0 Evaluation Pipeline Test Suite")
    print("="*80)
